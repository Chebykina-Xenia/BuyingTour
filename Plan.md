...
Заходим на сайт [сервиса по покупке тура](http://localhost:8080/) — Нажимаем на кнопку «Купить» — открывается форма «Оплата по карте».
...
| Месяц             | Вводим значение в диапазоне 01-12, но если ставим текущий год, то месяц должен быть больше или равен текущему |
...
### Негативные сценарии
**Основная задача:** проверить ввод невалидных данных в одно из полей, а в другие поля вводит валидные значения.
...
| 16 цифр               | Сообщение: Карта не подходит для оплаты |
...
| Символы                                               | Не даёт вводить символы                       |
| Буквы на латинице                                     | Не даёт вводить буквы                         |
| Если вводим текущий год, вводим месяц меньше текущего | Сообщение: Неверно указан срок действия карты |
